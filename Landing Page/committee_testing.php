...
<body>
    ...
    <div class="profile-container">
        <div class="profile" style="background-image: url('/bootstrap table/sumaya_GUCC.jpg');">
            <div class="overlay">
                <div class="about d-flex flex-column">
                    <h4 style="font-size:3vh">Sumaya Sultana</h4>
                    <span style="font-size:2vh">TREASURER</span>
                </div>
                <ul class="social-icons">
        ...
        <div class="profile" style="background-image: url('/bootstrap table/sami.jpg');">
            <div class="overlay">
                <div class="about d-flex flex-column">
                    <h4 style="font-size:3vh">MD Samiul Islam</h4>
        ...
        <div class="profile" style="background-image: url('/bootstrap table/ahmed.jpg');">
            <div class="overlay">
                <div class="about d-flex flex-column">
                    <h4 style="font-size:3vh">Ahmed Islam</h4>
                    <span style="font-size:2vh">ORGANIZING SECRETORY</span>
                </div>
                <ul class="social-icons">
                    <li><i class="fa fa-facebook"></i></li>
                    <li><i class="fa fa-linkedin"></i></li>
        ...
        <div class="profile" style="background-image: url('/bootstrap table/nadia.jpg');">
            <div class="overlay">
                <div class="about d-flex flex-column">
                    <h4 style="font-size:3vh">Nadia Esrat</h4>
                    <span style="font-size:2vh">JOINT ORGANIZING SECRETORY</span>
                </div>
                <ul class="social-icons">
                    <li><i class="fa fa-facebook"></i></li>
                    <li><i class="fa fa-linkedin"></i></li>
        ...
        <div class="profile" style="background-image: url('/bootstrap table/abir.jpg');">
            <div class="overlay">
                <div class="about d-flex flex-column">
                    <h4 style="font-size:3vh">Faysal Sarker</h4>
                    <span style="font-size:2vh">SPORTS SECRETORY</span>
                </div>
                <ul class="social-icons">
                    <li><i class="fa fa-facebook"></i></li>
                    <li><i class="fa fa-linkedin"></i></li>
