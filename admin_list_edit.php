                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                <h2 class="text-uppercase text-center mb-5">ADMIN PROFILE EDIT</h2>
                                <?php
                                    ...
                                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                        ...
                                        // Perform SQL query to update data in the database
                                        $sql = "UPDATE admin SET Name='$adminName', Email='$adminEmail', Password='$adminPassword' WHERE A_ID='$adminId'";

                                        if (mysqli_query($conn, $sql)) {
                                            // Alert box for successful update
                                            echo "<script>
                                                Swal.fire({
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" name="admin_id" id="form3Example1cg" class="form-control form-control-lg" value="<?php echo $retrievedId; ?>" readonly>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn btn-success btn-block btn-lg  text-body" style="background:##161743" onclick="confirmUpdateAdmin()">SAVE CHANGES</button>
                                    </div>
